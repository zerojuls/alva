...
export interface RadioProps {
	...
	/** @name Group Name @default radio1 */
	groupName?: string;
...
const StyledRadio = styled.div`
	...
	${(props: StyledRadioProps) => (props.disabled ? `border-color: ${Colors.Grey90};` : '')};
...
export const Radio: React.StatelessComponent<RadioProps> = (props): JSX.Element => {
