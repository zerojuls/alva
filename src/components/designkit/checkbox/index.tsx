...
const StyledLabel = styled.label`
	...
	${(props: StyledLabelProps) => (props.disabled ? `color: ${Colors.Grey90};` : '')};
`;
...
const StyledCheckbox = styled.div`
	...
	${(props: StyledCheckboxProps) => (props.disabled ? `border-color: ${Colors.Grey90};` : '')};
`;
...
const SyledCheckmark = styled.svg`
	...
	${(props: StyledCheckmarkProps) =>
		props.disabled ? `fill: ${Colors.Grey90};` : `fill: ${Colors.Green};`};
`;
...
export const Checkbox: React.StatelessComponent<CheckboxProps> = (props): JSX.Element => {
